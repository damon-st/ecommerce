...
public class MensajesComprasFragment extends Fragment {
    ...
    public MensajesComprasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista =  inflater.inflate(R.layout.fragment_mensajes_compras, container, false);

        recyclerView = vista.findViewById(R.id.recycler_view_compras);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Chat, MensajesComprasFragment.ChatsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Chat, MensajesComprasFragment.ChatsViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull final MensajesComprasFragment.ChatsViewHolder holder, int position, @NonNull Chat model) {

                        final String usersID = getRef(position).getKey();
                        final String pid = model.getPid();
                        final String sender = model.getReceiver();
                                            ...
                                            UserRef.child(sender).addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.child("image").exists()){
                                                        ...
                                                        holder.userStatus.setText("Vendedor: "+retName[0]);
                                                        retImage[0] = dataSnapshot.child("image").getValue().toString();
                    ...
                    @NonNull
                    @Override
                    public MensajesComprasFragment.ChatsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.displayuno,viewGroup,false);
                        return new MensajesComprasFragment.ChatsViewHolder(view);
