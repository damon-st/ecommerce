...
public class CalificacionNeutras extends Fragment {

    String sellerID;
    private DatabaseReference calfRef, userRef,productRef;
    ...
    public CalificacionNeutras() {
        // Required empty public constructor
    }



    public CalificacionNeutras(String sellerID){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.fragment_calificacion_neutras, container, false);

        recyclerView = view.findViewById(R.id.recycler_calf_neutro);

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext(),LinearLayoutManager.VERTICAL,false));

        calfRef = FirebaseDatabase.getInstance().getReference("Calificaciones");
        userRef = FirebaseDatabase.getInstance().getReference("Users");
        productRef = FirebaseDatabase.getInstance().getReference("Products");

        options = new FirebaseRecyclerOptions.Builder<Calificaciones>()
                .setQuery(calfRef.orderByChild("sellerID").equalTo(sellerID),Calificaciones.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Calificaciones, CalfViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final CalfViewHolder holder, int i, @NonNull Calificaciones calificaciones) {
                    ...
                    if (estado.equals("neutro")){
                        ...
                        holder.texto_titulo.setText("Puntuacion Neutra");
